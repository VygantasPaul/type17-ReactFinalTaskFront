...
const VoteBoxAnswers: React.FC<VoteBoxAnswersType> = ({
  answer,
  onLike,
  onDislike,
}) => {
  const likesCount = answer?.gained_likes_number?.length ?? 0;
